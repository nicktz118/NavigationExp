...
import com.nicktz9.navigationsample.databinding.FragmentDBinding
...
class DFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.screenName.text = "D"
        binding.action.setOnClickListener {
            findNavController().navigate(R.id.action_d_fragment_to_e_fragment)
        }
        return root
    }
